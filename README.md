...
# Konfigurasi File Penyimpanan Lokal (Al-Haqq Protocol Storage)
...
def main():
    while True:
        ...
        print("9. Lihat Arsip Bagan Pairing")
        print("10. Ekspor Laporan Dokumen (CSV & Master JSON)")
        print("11. Sync & Auto-Backup ke GitHub (Cloud Info)")
        print("12. Keluar")
        ...
        if choice == '1': menu_registrasi_tim()
            ...
            print_header()
            print("--- OTOMATISASI SINKRONISASI GITHUB ---")
            print("[i] Repositori: https://github.com/SyamsMaulana/god-of-fate-operations")
            print("[i] Gunakan metode unggah manual via web browser jika terminal terkendala.")
            input("\nTekan Enter untuk kembali...")
        elif choice == '12':
